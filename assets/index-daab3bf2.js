...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function fa(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qr(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function da(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qr(),fragmentShader:`
...
`].filter(ri).join(`
`)),o=Yr(o),o=Ea(o,t),o=Ta(o,t),a=Yr(a),a=Ea(a,t),a=Ta(a,t),o=ya(o),a=ya(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(A=`#version 300 es
