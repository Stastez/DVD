...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function ha(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Jr(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function fa(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Jr(),fragmentShader:`
...
`].filter(ri).join(`
`)),o=Xr(o),o=Sa(o,t),o=Ea(o,t),a=Xr(a),a=Sa(a,t),a=Ea(a,t),o=Ta(o),a=Ta(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(A=`#version 300 es
